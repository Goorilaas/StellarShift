...
- [ ] **Розширити різноманіття пулу при вищих API-лімітах** — коли отримаємо збільшений ліміт Unsplash: (1) підняти стелю запитів вище 44; (2) дати ВСІМ категоріям по 20+ під-запитів (зараз лише 6 категорій мають); (3) можливо розширити списки понад 20 і брати ще більше на категорію (зараз 4–6). Переглянути banди `subCountForMix` під новий бюджет
