...
export const CATEGORY_QUERIES: Record<string, string[]> = {
    ...
    abstract: [
        'abstract geometric pattern', 'colorful fluid art', 'liquid marble texture',
        'iridescent holographic', 'minimal color gradient', 'abstract paint swirls',
        'neon light abstract', 'smoke art on black', 'glass refraction abstract',
        'pastel abstract waves', 'metallic flow abstract', 'low poly geometric art',
        'ink in water abstract', 'soft bokeh lights', 'abstract 3d shapes',
    ],
    food: [
        'gourmet plated dish', 'artisan coffee cup', 'fresh fruit flat lay',
        'rustic bread pastry', 'colorful smoothie bowl', 'sushi platter',
        'chocolate dessert closeup', 'healthy salad bowl', 'pizza overhead',
        'berries and cream', 'cocktail with garnish', 'cheese and wine board',
        'breakfast pancakes', 'steaming ramen bowl', 'pastel macarons',
    ],
    flowers: [
        'blooming roses closeup', 'wildflower field', 'cherry blossom branch',
        'tulip field rows', 'lavender bloom', 'sunflower close up',
        'peony macro', 'elegant orchid', 'red poppy field',
        'daisy meadow', 'lotus on water', 'blue hydrangea',
        'dried flower bouquet', 'flower petals macro', 'magnolia spring',
    ],
    cyberpunk: [
        'neon cyberpunk alley', 'futuristic city night', 'blade runner cityscape',
        'neon signs at night', 'cyberpunk skyline glow', 'sci-fi megacity',
        'holographic city lights', 'dark dystopian city', 'neon tunnel',
        'futuristic architecture night', 'tokyo neon street', 'synthwave city sunset',
        'glowing skyscrapers fog', 'cyberpunk neon interior', 'rainy neon downtown',
    ],
    cities: [
        'city skyline aerial', 'downtown skyscrapers', 'urban geometric architecture',
        'city at night lights', 'empty street morning', 'bridge city view',
        'rooftop city panorama', 'modern glass buildings', 'narrow european alley',
        'city reflections river', 'metro station architecture', 'foggy city skyline',
        'urban staircase geometry', 'city long exposure lights', 'aerial intersection top down',
    ],
    minimal: [
        'minimal pastel background', 'single object minimalism', 'minimal architecture lines',
        'negative space minimal', 'soft gradient minimal', 'minimalist still life',
        'clean geometric minimal', 'muted tone minimal', 'minimal zen nature',
        'lone tree minimal', 'minimal shadow play', 'monochrome minimal shapes',
        'calm minimal seascape', 'minimal desert dune', 'simple line composition',
    ],
    seasons: [
        'autumn forest colors', 'snowy winter landscape', 'spring cherry blossoms',
        'summer golden field', 'autumn leaves falling', 'frosty morning trees',
        'spring green meadow', 'winter snow cabin', 'fall foliage road',
        'blooming spring orchard', 'summer wildflower field', 'icy frozen lake',
        'autumn mountain valley', 'first snow on pines', 'vibrant fall maple',
    ],
    bw: [
        'black and white street', 'monochrome portrait', 'high contrast architecture bw',
        'foggy monochrome landscape', 'black white minimalism', 'noir street photography',
        'bw long exposure sea', 'monochrome mountains', 'black white cityscape',
        'dramatic bw clouds', 'bw forest light rays', 'silhouette black white',
        'monochrome still life', 'grainy film black white', 'black white spiral staircase',
    ],
    cars: [
        'classic vintage car', 'supercar studio shot', 'sports car on road',
        'motorcycle on highway', 'retro car closeup', 'luxury car detail',
        'muscle car front', 'car headlight macro', 'off road truck',
        'racing car track', 'car in neon light', 'convertible coast road',
        'car wheel rim closeup', 'electric car modern', 'car silhouette sunset',
    ],
    yachts: [
        'luxury yacht ocean', 'sailing boat sunset', 'yacht aerial top down',
        'sailboat open sea', 'yacht marina harbor', 'catamaran turquoise water',
        'yacht deck view', 'sailing regatta race', 'superyacht aerial',
        'boat wake ocean', 'yacht anchored bay', 'sailboat silhouette sunset',
        'wooden sailboat classic', 'yacht tropical lagoon', 'speedboat ocean spray',
    ],
    architecture: [
        'modern building facade', 'minimalist architecture interior', 'brutalist concrete building',
        'glass skyscraper abstract', 'spiral staircase architecture', 'symmetrical building facade',
        'arched corridor architecture', 'futuristic museum interior', 'geometric ceiling design',
        'historic cathedral interior', 'white minimal architecture', 'abstract building lines',
        'atrium glass roof', 'japanese minimalist house', 'parametric facade pattern',
    ],
    forest: [
        'misty pine forest', 'sunbeams through trees', 'dense green woodland',
        'autumn forest path', 'tall redwood trees', 'foggy forest morning',
        'forest canopy from below', 'mossy forest floor', 'dark moody forest',
        'birch tree forest', 'forest stream rocks', 'bamboo forest path',
        'snowy winter forest', 'ancient mossy trees', 'forest light rays fog',
    ],
    travel: [
        'ancient temple landmark', 'santorini white buildings', 'tropical beach paradise',
        'mountain village europe', 'historic old town', 'desert landscape travel',
        'iconic city landmark', 'coastal cliff village', 'rice terraces aerial',
        'venice canal view', 'moroccan architecture', 'lighthouse on coast',
        'great wall landscape', 'alpine village valley', 'tropical island aerial',
    ],
    mist: [
        'foggy forest morning', 'misty mountain valley', 'fog over lake',
        'hazy sunrise landscape', 'misty pine trees', 'foggy road vanishing',
        'mist over hills', 'atmospheric foggy field', 'low fog meadow',
        'mountain peaks above clouds', 'misty river morning', 'foggy coastline',
        'ethereal misty forest', 'fog rolling over valley', 'dreamy hazy landscape',
    ],
    noir: [
        'dark moody cinematic', 'film noir shadows', 'dramatic low key light',
        'moody rainy night', 'cinematic dark street', 'shadow and light contrast',
        'noir window blinds light', 'dark atmospheric portrait', 'moody dark interior',
        'silhouette in shadow', 'neon noir night', 'dramatic chiaroscuro',
        'dark cinematic landscape', 'smoky noir room', 'moody black shadows',
    ],
    rural: [
        'countryside rolling hills', 'old barn field', 'rustic farmhouse',
        'golden wheat field', 'village cottage garden', 'country road autumn',
        'lavender farm rows', 'vineyard hillside', 'rural meadow sunset',
        'stone cottage countryside', 'hay bales field', 'farmland aerial patchwork',
        'rustic wooden fence path', 'tuscany countryside', 'misty rural valley',
    ],
};
