...
> **ІСТОРИЧНА НОТАТКА (2026-09-24).** Старі твердження про втрату ключів і процедури відновлення не використовувати як актуальну гарантію чи інструкцію. Наявний production-підпис зберігаємо; новий ключ без окремого рішення не створюємо.
